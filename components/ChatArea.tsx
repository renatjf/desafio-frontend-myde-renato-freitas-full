  ...
  return (
    ...
    >
        ...
        {conversation ? (
          <>
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-xs text-[var(--muted)]">{formatPhone(conversation.contactPhone)}</p>
            </div>
          </>
        ) : (
      ...
      >
        ...
        {isError && (
          <ErrorState message="Não foi possível carregar as mensagens." onRetry={() => refetch()} />
        )}

        {!isLoading && !isError && grouped.length === 0 && (
          <EmptyState icon="💬" title="Sem mensagens ainda" description="Envie a primeira mensagem para iniciar a conversa." />
        )}
